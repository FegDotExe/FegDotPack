...
scoreboard players operation @e[type=player,scores={fegDsSwitched=1,fegDsInGame=1}] fegDsSwId = @e[type=armor_stand,name="fegDsCounter"] fegDsToSwitch
scoreboard players set @e[type=player,scores={fegDsSwitched=1,fegDsInGame=1}] fegDsSwitched 2
